...
import { calculateAffinityModifiers } from './affinity.engine';
...
// Note: getDemographicModifier has been replaced by the new Audience Affinity Engine
// See calculateAffinityModifiers in affinity.engine.ts for the new implementation
...
export const _calculateKpis = (
  ...
  // Apply affinity modifiers using the new Audience Affinity Engine
  const affinityModifiers = targetAudience ? calculateAffinityModifiers(targetAudience, platform, industry) : { cpm_mod: 1.0, ctr_mod: 1.0, cvr_mod: 1.0 };
  ...
  // Combine all modifiers with the new Audience Affinity Engine
  const finalCpmModifier = combineMultipliers([
    seasonalCpmMultiplier,
    industryCpmModifier,
    creativeCpmModifier,
    competitionCpmModifier,
    affinityModifiers.cpm_mod,
